  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#050A14] text-white">
        ...
        <div className="flex h-20 items-center justify-between py-6">
          ...
          <div className="flex-1 flex justify-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-bold inline-block text-2xl">Spots</span>
            </Link>
          </div>
      ...
      <main className="flex-1">
        ...
        <section
          id="features"
          className="container space-y-6 py-16 md:py-20 lg:py-24"
        >
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            <h2 className="text-3xl font-bold leading-[1.1] sm:text-3xl md:text-5xl">
              Features
            </h2>
            <p className="max-w-[85%] leading-normal text-white/60 sm:text-lg sm:leading-7">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-6 md:grid-cols-3">
            <div className="rounded-lg border border-white/5 bg-white/3 p-6">
              <div className="mb-4 text-[#4ECDC4]/80">
            ...
            <div className="rounded-lg border border-white/5 bg-white/3 p-6">
              <div className="mb-4 text-[#AAC789]/80">
                <Icon name="ChatCircleText" size="xl" weight="duotone" />
              </div>
              <h3 className="mb-2 text-xl font-bold">Natural Language Search</h3>
              <p className="text-white/60">
                Ask for recommendations in natural language, just like chatting with a friend.
              </p>
            </div>
            <div className="rounded-lg border border-white/5 bg-white/3 p-6">
              <div className="mb-4 text-[#FF6B6B]/80">
                <Icon name="Lightbulb" size="xl" weight="duotone" />
              </div>
              <h3 className="mb-2 text-xl font-bold">Contextual Awareness</h3>
              <p className="text-white/60">
          ...
          <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            ...
            <Link 
              ...
              className={cn(
                ...
                "mt-4 bg-[#4ECDC4]/90 hover:bg-[#4ECDC4]"
              )}
            >
      ...
      <footer className="border-t border-white/5 py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <div className="flex gap-4">
            <Link href="/terms" className="text-sm text-white/60 underline underline-offset-4">
              Terms
            </Link>
            <Link href="/privacy" className="text-sm text-white/60 underline underline-offset-4">
              Privacy
            </Link>
          </div>
        </div>
